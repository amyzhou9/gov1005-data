...
# Pass API key to requests
headers = {'Authorization': 'cf724e90025a41588164b69fd283820e'}
...
everything_payload = {'language': 'en', 'sources':'bbc-news', 'pageSize':'100'}
...
df.to_csv('/Users/amyzhou/Desktop/bbc_1.csv')
